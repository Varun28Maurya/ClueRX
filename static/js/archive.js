...
summary: "Mucormycosis caused by Rhizopus and Mucor. Infection occurs after inhalation of spores in susceptible patients, especially those with uncontrolled diabetes or ketoacidosis. These molds form broad, non-septate hyphae that invade blood vessels, leading to thrombosis, poor blood supply, and rapid tissue death in the sinuses with extension toward the orbit and brain. This angioinvasive nature explains the rapidly progressive course and dark, devitalized nasal tissue. IV liposomal amphotericin B, urgent surgical removal of dead tissue, and correction of underlying risk factors, followed by step-down therapy with posaconazole or isavuconazole."
  ...
  "title": "Amoebiasis",
  "date": "May 16, 2026",
  "answer": "Entamoeba histolytica(Amoebiasis)",
  "question": "A 33-year-old man has 10 days of abdominal pain, bloody mucus stools, and low-grade fever.",
  "clues": [
    "He returned two weeks ago from a rural trip where he consumed untreated water and street food.",
    "Over the past 3 days, he has developed right upper quadrant abdominal pain and fatigue.",
    "Ultrasound of the abdomen shows a solitary hypoechoic lesion in the right lobe of the liver.",
    "Stool microscopy reveals motile trophozoites containing ingested red blood cells.",
    "Physician started treatment with Metronidazole"
  ],
  "summary": "Amoebiasis caused by Entamoeba histolytica. This parasite is an invasive protozoan acquired from contaminated food or water. After ingestion, cysts release trophozoites that invade the colonic mucosa, causing bloody mucus diarrhea and abdominal pain. The parasite can enter the portal circulation and reach the liver, forming a solitary abscess. Treatment requires metronidazole to kill tissue forms followed by a luminal agent to clear intestinal cysts and prevent recurrence."
},
{
  "id": "micro-parasite-2",
  "domain": "microbiology",
  ...
  "question": "A 2-week-old newborn has poor feeding, jaundice, and jerky movements with eye rolling.",
  "clues": [
    "Mother owns cats at home and often handled their litter without precautions.",
    "On examination, the infant has an enlarged liver and spleen and decreased responsiveness to stimuli.",
    "phthalmologic evaluation reveals inflammation at the back of the eye affecting vision.",
    "Neuroimaging of the head shows multiple intracranial calcifications with enlarged ventricles.",
    "Physician started TMP-SMX"
  ],
  "summary": "Congenital toxoplasmosis caused by Toxoplasma gondii. Parasite is an intracellular protozoan acquired when a pregnant woman ingests oocysts from cat feces or tissue cysts from undercooked meat. The parasite crosses the placenta during maternal infection and invades fetal tissues, especially the brain and eyes, leading to intracranial calcifications, hydrocephalus, chorioretinitis, jaundice, and hepatosplenomegaly. Early recognition and prolonged treatment are essential to limit neurologic and visual damage."
},
{
  "id": "micro-parasite-3",
  "domain": "microbiology",
  "subdomain": "parasite",
  "title": "Chronic quartan malaria",
  "date": "May 16, 2026",
  "answer": "Plasmodium malariae",
  "question": "A 46-year-old wildlife surveyor has months of intermittent fever, fatigue, facial puffiness, and leg swelling.",
  "clues": [
    "He worked for a year in a remote rainforest region with intense mosquito exposure and did not use prophylaxis.",
    "Over the past month, he noticed frothy urine and reduced exercise tolerance.",
    "Peripheral smear shows band-form trophozoites in red blood cells with low parasitemia.",
    "No Liver Stage relapse and He recalls that his fevers follow a regular pattern every fourth day",
    "Preferablly target older RBCs."
  ],
  "summary": "Chronic quartan malaria due to Plasmodium malariae. Plasmodium malariae is a malaria species that produces fever spikes every 72 hours and typically causes low parasitemia with a long-lasting infection. Persistent circulation of parasite antigens leads to immune complex deposition in the kidneys, resulting in nephrotic syndrome with heavy proteinuria, edema, and impaired renal function. The smear finding of band-form trophozoites and the chronic course help distinguish this infection from other malaria species."
},
{
  "id": "micro-parasite-4",
  "domain": "microbiology",
  "subdomain": "parasite",
  "title": "Relapsing tertian malaria",
  "date": "May 16, 2026",
  "answer": "Plasmodium vivax/Ovale",
  "question": "A 25-year-old graduate student presents with recurrent episodes of fever for the past 2 months.",
  "clues": [
    "He reports that these fevers first started shortly after returning from a backpacking trip across Southeast Asia.",
    "He received antimalarial therapy during the trip, which briefly resolved the fever, but it recurred weeks later.",
    "Peripheral smear shows enlarged red blood cells containing trophozoites with fine stippling",
    "Each attack starts with chills, then high fever and profuse sweating, recurring every third day.",
    "Preferablly target the Reticulocytes."
  ],
  "summary": "Relapsing tertian malaria due to Plasmodium vivax or Plasmodium ovale.This case describes periodic fever occurring every third day that returned weeks after initial improvement with antimalarial therapy—classic for relapse caused by dormant liver stages (hypnozoites). P. vivax and P. ovale infect hepatocytes first, where some parasites become hypnozoites that can remain inactive and later reactivate, causing recurrent blood-stage infection. In the blood, the parasites invade red blood cells, multiply, and synchronously rupture them, producing the cyclical chills, high fever, and drenching sweats (tertian pattern). Unlike P. falciparum, these species are less likely to cause severe complications but are notable for relapse if the liver stage is not eradicated."
},
{
  "id": "micro-parasite-5",
  "domain": "microbiology",
  ...
  "question": "A 29-year-old humanitarian worker returns from a 3-week trip to rural west Africa.",
  "clues": [
    "Five days after returning, he develops high fever with chills, headache, muscle aches, and extreme fatigue.",
    "He has a very high fever, low BP, fast pulse and breathing, looks jaundiced and confused, with mild liver and spleen enlargement and no neck stiffness.",
    "Parasitemia is reported at 9%.",
    "The blood smear shows many fine ring-shaped parasites inside red blood cells, with some cells having multiple rings, along with crescent-shaped forms."
  ],
  "summary": "Malaria due to Plasmodium falciparum.The most dangerous human malaria parasite. It infects red blood cells of all ages, leading to very high levels of parasites in the blood. On smear, it classically shows delicate ring forms, multiple parasites within a single red cell, and characteristic crescent (banana)-shaped gametocytes. The parasite’s ability to make infected red cells stick to blood vessel walls causes blockage of small vessels, leading to complications like jaundice, confusion, shock, and organ failure. P. falciparum does not form dormant liver stages, but it can rapidly progress to life-threatening disease if not treated promptly."
},
{
  "id": "micro-parasite-6",
  "domain": "microbiology",
  ...
  "title": "Babesiosis",
  "date": "May 16, 2026",
  "answer": "Babesia microti(Babesiosis)",
  "question": "A 67-year-old man presents with 6 days of high fever, heavy sweating, marked fatigue, and dark urine.",
  "clues": [
    "Two weeks ago, he returned from a hiking trip in a wooded area of the northeastern United States",
    "His past medical history is significant for a splenectomy following trauma many years ago.",
    "Mild scleral icterus is noted. The liver is slightly enlarged",
    "A peripheral blood smear shows numerous ring-like organisms inside red blood cells.",
    "Some cells contain four organisms arranged in a tetrad formation."
  ],
  "summary": "Babesiosis. This illness is caused by Babesia microti, a protozoan parasite that infects red blood cells and is transmitted to humans through the bite of the Ixodes scapularis (the same tick that spreads Lyme disease). After entering the bloodstream, the parasite multiplies inside erythrocytes, leading to their destruction and causing fever, fatigue, anemia, jaundice, and dark urine from hemolysis. It is more severe in elderly or immunocompromised patients and may also spread rarely through blood transfusion. Treatment typically includes atovaquone with azithromycin, or clindamycin with quinine in severe cases."
},
{
  "id": "micro-parasite-7",
  "domain": "microbiology",
  ...
  "question": "A 27-year-old man from a rural South American village has 10 days of fever, body aches, and swelling around his right eye.",
  "clues": [
    "He lives in a mud-brick, thatched house and often notices large night-active insects in the wall cracks, waking with bites on his face.",
    "Cardiac evaluation reveals dilated cardiomyopathy with arrhythmias.",
    "Imaging of the gastrointestinal tract shows significant dilation of the esophagus and colon.",
    "peripheral blood smear reveals motile, elongated flagellated organisms.",
    "Patient is treated with the Benznidazole"
  ],
  "summary": "Chagas disease (American trypanosomiasis) caused by Trypanosoma cruzi. This infection begins after the parasite is transmitted by a nocturnal reduviid (“kissing”) bug that lives in mud-brick houses and feeds on the face at night. The organism enters through the bite site or conjunctiva, causing early fever, lymph node enlargement, hepatosplenomegaly, and characteristic unilateral periorbital swelling. Over years, the parasite persists in tissues—especially cardiac muscle and the enteric nervous system—leading to dilated cardiomyopathy, arrhythmias, and marked dilation of the esophagus and colon due to destruction of autonomic ganglia."
},
{
  "id": "micro-parasite-8",
  "domain": "microbiology",
  ...
  "question": "A 24-year-old graduate student returns from 4 months of fieldwork in rural villages along a river basin in South Asia.",
  "clues": [
    "Two months after returning, he develops intermittent fever, fatigue, poor appetite, and weight loss.",
    "There is marked enlargement of the spleen and moderate enlargement of the liver.",
    "Laboratory studies reveal pancytopenia with anemia, leukopenia, and thrombocytopenia.",
    "Bone marrow microscopy shows many small oval organisms inside macrophages",
    "He remembers frequent bites from tiny, quiet insects in the evenings while working near cattle shelters."
  ],
  "summary": "Visceral leishmaniasis (kala-azar) caused by Leishmania donovani.This protozoan is transmitted by the bite of female sandflies and enters macrophages, where it survives and multiplies as intracellular amastigotes. Ongoing infection of the reticuloendothelial system (bone marrow, liver, spleen) leads to prolonged fever, weight loss, darkening of skin, massive splenomegaly, and pancytopenia due to marrow suppression and hypersplenism."
},
{
  "id": "micro-parasite-9",
  "domain": "microbiology",
  ...
  "question": "A 7-year-old boy has 3 weeks of low-grade fever, seizures, abdominal discomfort, and visual imapairment.",
  "clues": [
    "The family recently adopted a young puppy that has not yet received routine veterinary care.",
    "He has wheezing and dyspnea on exertion",
    "He is pale and mildly febrile, with an enlarged tender liver and a granulomatous lesion in the retina.",
    "After 2 hours he developed an Arrhythmia.",
    "Stool examination does not reveal any ova or parasites."
  ],
  "summary": "Toxocariasis caused by Toxocara canis.Humans ingest embryonated eggs from contaminated soil or dirty hands. The larvae hatch, penetrate the intestine, and migrate through organs (liver, lungs,heart, eye) without maturing, triggering eosinophilic inflammation and granuloma formation. This larval migration explains fever, hepatomegaly, pulmonary symptoms, and retinal lesions (visceral and ocular larva migrans)."
},
{
  "id": "micro-parasite-10",
  "domain": "microbiology",
  "subdomain": "parasite",
  "title": "Neurocysticercosis",
  "date": "May 16, 2026",
  "answer": "Taenia solium",
  "question": "A 28-year-old man is brought to the emergency department after a first-time generalized seizure.",
  "clues": [
    "He often ate street food and had poor hand hygiene.",
    "Over the past 2 months, he has had recurrent headaches, nausea, and occasional vomiting.",
    "Brain MRI shows multiple cystic lesions in the cortex and ventricles with surrounding edema.",
    "A few lesions show a small dot-like structure within the cyst.4",
    "Serologic testing for parasitic infections is positive for antibodies against a cestode parasite."
  ],
  "summary": "Neurocysticercosis due to Taenia solium.Humans acquire infection by ingesting tapeworm eggs from contaminated food or poor hand hygiene. The eggs hatch in the intestine, release larvae that enter the bloodstream, and lodge in the brain where they form fluid-filled cysts. The host inflammatory response to these cysts causes edema, raised intracranial pressure, headaches, and seizures."
},
{
  "id": "micro-parasite-11",
  "domain": "microbiology",
  "subdomain": "parasite",
  "title": "Diphyllobothriasis",
  "date": "May 16, 2026",
  "answer": "Diphyllobothrium latum",
  "question": "A 41-year-old man has 3 months of worsening fatigue, dizziness, and numbness in his hands and feet.",
  "clues": [
    "He frequently consumed homemade dishes prepared with lightly salted, raw freshwater fish.",
    "Neurologic examination reveals decreased vibration and position sense in both lower limbs and a mildly ataxic gait.",
    "Peripheral smear: macrocytosis with hypersegmented neutrophils.",
    "Serum vitamin B12: markedly low  Folate: normal",
    "Stool examination reveals numerous oval operculated eggs and occasional broad, flat segments."
  ],
  "summary": "Diphyllobothriasis due to Diphyllobothrium latum.This fish tapeworm is acquired by eating raw or undercooked freshwater fish containing infective larvae. In the intestine, the worm grows to a large size and competes for dietary vitamin B12, leading to deficiency. The resulting megaloblastic anemia and neurologic symptoms (numbness, gait disturbance) occur because vitamin B12 is essential for red blood cell formation and myelin maintenance."
},
{
  "id": "micro-parasite-12",
  "domain": "microbiology",
  "subdomain": "parasite",
  "title": "Hydatid disease",
  "date": "May 16, 2026",
  "answer": "Echinococcus granulosus",
  "question": "A 35-year-old shepherd has 4 months of dull right upper abdominal pain, early satiety, and intermittent nausea.",
  "clues": [
    "He has worked with sheep and cattle since childhood",
    "There is no hepatomegaly or splenomegaly.",
    "Ultrasound shows a large cyst in the right liver lobe with multiple smaller cysts inside.",
    "He suddenly develops hives, low blood pressure, and breathing difficulty after minor abdominal trauma.",
    "After surgical removal, the cyst wall appears thick and calcified, resembling an eggshell."
  ],
  "summary": "Hydatid disease caused by Echinococcus granulosus.Humans acquire this infection by ingesting eggs from dog feces, often through contaminated hands, food, or water in farm settings. The larvae migrate to the liver and form slowly enlarging hydatid cysts with daughter cysts inside. Leakage or rupture of the cyst can release antigenic fluid, triggering urticaria, hypotension, and breathing difficulty due to an allergic reaction."
},
  {
