const records = [
  ...
  },
  {
    ...
    question: "A patient develops tendon pain after treatment for a urinary infection. Which drug class is most likely involved?",
    clues: [
      "This class can prolong the QT interval.",
      "It can cause tendinopathy and tendon rupture.",
      "It has activity against gram-negative organisms.",
      "It should be used carefully in older adults.",
  ...
  },
  {
    ...
    title: "Demo Test 4",
    answer: "Warfarin",
    question: "A patient taking an anticoagulant needs regular INR monitoring. Which drug is this?",
    clues: [
      "It inhibits vitamin K-dependent clotting factors.",
      "Dietary vitamin K can affect dosing.",
      "Bleeding is the major toxicity.",
      "It is reversed with vitamin K.",
      "The drug is warfarin."
    ]
  },
  {
    id: "demo-5",
    title: "Demo Test 5",
    answer: "Aspirin",
    question: "A patient develops ringing in the ears after taking high doses of a pain reliever. Which drug is most likely?",
    clues: [
      "It is an NSAID.",
      "It irreversibly inhibits platelets.",
      "It can cause salicylism at toxic doses.",
      "It is avoided in children with viral illness.",
      "The drug is aspirin."
    ]
  },
  {
